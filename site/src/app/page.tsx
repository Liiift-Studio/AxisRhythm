		...
		<main className="flex flex-col items-center px-6 py-20 gap-24">
			...
			<section className="w-full max-w-2xl lg:max-w-5xl flex flex-col gap-6">
				<div className="flex flex-col gap-2">
					<p className="text-xs uppercase tracking-widest opacity-50">axis-rhythm</p>
				...
				<div className="flex items-center gap-4">
					<CopyInstall />
					<a href="https://github.com/quitequinn/axis-rhythm" target="_blank" rel="noopener noreferrer" className="text-sm opacity-50 hover:opacity-100 transition-opacity">GitHub ↗</a>
				</div>
			...
			<section className="w-full max-w-2xl lg:max-w-5xl flex flex-col gap-6">
				...
				<div className="flex flex-col gap-8 text-sm">
					<div className="flex flex-col gap-3">
						...
						<CodeBlock code={`import { AxisRhythmText } from '@liiift-studio/axis-rhythm'
...
<AxisRhythmText axis="wdth" values={[100, 88]} period={2}>
  Your paragraph text here...
					...
					<div className="flex flex-col gap-3">
						...
						<CodeBlock code={`import { useAxisRhythm } from '@liiift-studio/axis-rhythm'
...
<p ref={ref}>{children}</p>`} />
					...
					<div className="flex flex-col gap-3">
						...
						<CodeBlock code={`import { applyAxisRhythm } from '@liiift-studio/axis-rhythm'
...
applyAxisRhythm(el, original, { axis: 'wdth', values: [100, 88], period: 2 })`} />
			...
			<footer className="w-full max-w-2xl lg:max-w-5xl flex justify-between text-xs opacity-50 pt-8 border-t border-white/10">
				<span>axis-rhythm v{version}</span>
